...
25. [DEF CON](https://defcon.org/) is one of the [**oldest** continuously running hacker conventions](https://defcon.org/html/defcon-32/dc-32-index.html) around, also one of the largest and not entirely one of the worst ... although with its nerdware antics and contests like lockpicking, robotics-related contests, art, slogan, coffee wars, scavenger hunt, and Capture the Flag, it has become sort of a sociohistorical cliche of its nerdy recursive self.
